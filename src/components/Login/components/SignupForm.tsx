import { Button, Collapse, FormControl, FormHelperText, IconButton, InputLabel, MenuItem, Select, TextField } from '@material-ui/core';
...
const SignupForm: FunctionComponent = () => {
  ...
  async function handleSubmit(userData: UserForm) {
